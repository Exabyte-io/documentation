In order to organize and store the information about workflows we employ [Exabyte Data Convention](/data/overview.md) as explained elsewhere in this documentation.
