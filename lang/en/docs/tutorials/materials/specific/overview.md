...
This document provides a comprehensive catalog of materials science tutorials organized by the MCODE (Materials Classification and Organization for Digital Exploration) system. Each entry includes:

- **Structure Notebook**: Creates the atomic structure from published data
- **Property Notebook**: Calculates and reproduces key properties from the manuscript
...
**Property**: Surface Energy Calculation (Coming Soon)  
...
##### 1.2.1.1. Gold Nanoclusters <span class="btn badge b-info border-50">P-0D-NPR</span>

**Structure**: [Create Gold Nanocluster Structure](nanocluster-gold.md)  
**Property**: Formation Energy Calculation (Coming Soon)  
...
**Structure**: [Create High-k Metal Gate Stack](heterostructure-silicon-silicon-dioxide-hafnium-dioxide-titanium-nitride.md)  
**Property**: Band Alignment and Effective Work Function (Coming Soon)  
**Reference**: [QuantumATK Tutorial](https://docs.quantumatk.com/tutorials/hkmg_builder/hkmg_builder.html) [@Muller1999; @Robertson2006]
...
##### 2.1.3.1. Twisted Bilayer h-BN Nanoribbons <span class="btn badge b-info border-50">C-2D-INT-T</span>

**Structure**: [Create Twisted h-BN Nanoribbons](interface-bilayer-twisted-nanoribbons-boron-nitride.md)  
**Property**: Electronic Band Structure at Various Twist Angles (Coming Soon)  
...
**Property**: Band Gap Modulation and Optical Properties (Coming Soon)  
...
**Property**: Formation Energy and Electronic Structure (Coming Soon)  
...
**Property**: Formation Energy and Charge Transition Levels (Coming Soon)  
...
**Property**: Formation Energy and Magnetic Properties (Coming Soon)  
...
**Property**: Formation Energy and Diffusion Barriers (Coming Soon)  
...
##### 3.2.1.1. Grain Boundary in FCC Metals (Copper) <span class="btn badge b-info border-50">D-1D-GBL</span>

**Structure**: [Create Grain Boundary in Copper](defect-planar-grain-boundary-3d-fcc-metals-copper.md)  
**Property**: Grain Boundary Energy and Segregation (Coming Soon)  
...
**Property**: Formation Energy and Surface Stability (Coming Soon)  
...
**Property**: Island Formation Energy and Growth Mechanism (Coming Soon)  
...
**Property**: Step Formation Energy and Adsorption Sites (Coming Soon)  
...
**Property**: Adsorption Energy and Diffusion Barriers (Coming Soon)  
...
**Property**: Grain Boundary Formation Energy and Electronic Properties (Coming Soon)  
...
**Property**: Band Gap and Conductance Calculation (Coming Soon)  
...
##### 4.2.1.1. H-Passivated Silicon (100) Surface <span class="btn badge b-info border-50">X-2D-PAS</span>

**Structure**: [Create H-Passivated Si(100) Surface](passivation-surface-silicon.md)  
**Property**: Surface Energy and Electronic Structure (Coming Soon)  
...
**Property**: Mechanical Properties and Band Structure Modulation (Coming Soon)  
