...
The [Remote Desktop](../remote-desktop.md) connection method for accessing our platform is accessible under the corresponding `Remote Desktop` option available in the [Account Menu menu](../../ui/account-menu.md) of the [Web Interface](../../ui/overview.md).
